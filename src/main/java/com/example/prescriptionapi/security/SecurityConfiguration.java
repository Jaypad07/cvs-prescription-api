...
public class SecurityConfiguration {
    ...
    @Autowired
    public void setMyUserDetailsService(MyPatientDetailsService myPatientDetailsService) {
        this.myPatientDetailsService = myPatientDetailsService;
    }
    ...
    public MyPatientDetails myPatientDetails() {
        return (MyPatientDetails) SecurityContextHolder.getContext().getAuthentication()
                .getPrincipal();
    }
}
